This package allows you to easily add objects fading when they occur between camera and the player, 
using unity default URP shader transparency.

Be aware of the EasyObjectsFade.cs script. You must remember to set the 
layer mask to the layers that contain only default URP shaders.
If transparency makes object disappear you should check transparency
mask in urp forward renderer data asset.
