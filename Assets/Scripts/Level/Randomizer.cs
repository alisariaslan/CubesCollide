...
public class Randomizer : MonoBehaviour
{
    ...
    public async Task RandomizeGround()
    {
        ...
        {
            startRandomMapSize = Manager.Game.General.SelectedLevelIndex + 1;
            endRandomMapSize = Manager.Game.General.SelectedLevelIndex + 1;
        }
    ...
    public void OptimizeRandomize()
    {
        ...
        if (Manager.Game.General.SelectedGameMode == GameMode.BETHEBIGGEST)
        {
            ...
            if (optimizePlayerForGM)
            {
                Manager.Game.General.DefaultPayerSpeed = 1 + map_scale / 2;
                Manager.Game.General.DefaultBotSpeed = 1;
                Manager.Game.General.PlayerSpeed = Manager.Game.General.DefaultPayerSpeed;
                Manager.Game.General.BotSpeed = Manager.Game.General.DefaultBotSpeed;
            }
            if (optimizeBotForGM)
            {
                minBotSize = 0.1f;
